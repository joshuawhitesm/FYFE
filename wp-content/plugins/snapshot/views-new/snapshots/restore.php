...
<form id="snapshot-edit-restore" action="<?php echo WPMUDEVSnapshot::instance()->snapshot_get_pagehook_url( 'snapshots-newui-snapshots' ); ?>" method="post">
								...
								<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
									...
									<div class="box-mask">
										...
										<?php if ( is_multisite() ) { ?>
											...
											<?php if ( $blog_details->siteurl !== $item['MANIFEST']['WP_SITEURL'] ) { ?>
