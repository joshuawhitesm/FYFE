							...
							<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
								...
								<div class="box-mask">
									...
									<div class="wps-input--group">
										...
										<p><small><?php _e('URLs can be files and must be listed one per line. The exclusion logic uses pattern matching, so typing twentyten will exclude the twentyten folder, as well as any filters with twentyten in the filename.', SNAPSHOT_I18N_DOMAIN); ?></small></p>
														...
														foreach ( $tables as $table_key => $table_name ) {
															...
															<?php } else {
																...
																if ( isset( $_REQUEST['backup-tables'] ) ) {
																	...
																	if ( ( isset( $_GET['page'] ) ) && ( sanitize_text_field( $_GET['page'] ) == "snapshot_pro_snapshots" ) ) {
									...
									<div class="wps-input--group">
										...
										<div class="wps-input--item">
											...
											<div class="wps-input--radio">
												...
												<input id="frequency-once" type="radio" <?php if( isset( $item['interval']  ) && $item['interval']  == 'immediate' ) : ?>checked="checked" <?php endif; ?> name="frequency" value="once" />
										...
										<div class="wps-input--item">
											...
											<div class="wps-input--radio">
												...
												<input id="frequency-daily" type="radio" <?php if( isset( $item['interval']  ) && $item['interval']  != 'immediate' ) : ?>checked="checked" <?php endif; ?> name="frequency" value="schedule" />
									...
									<div id="snapshot-schedule-options-container" class="box-gray">
										...
										<div class="wps-input--item">
											...
											<div class="wps-input--checkbox">
												...
												<input type="checkbox" id="checkbox-run-backup-now" class="" value="1" />
