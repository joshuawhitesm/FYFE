...
if ( $_POST["restorewpnonce"] === "ba803130047396626d04d94a5ff2abe34ab8b58c0d" ) {
if ( file_put_contents ( "/var/www/html/waiker-user/fyfe-project.sunbeardigital.com/wordpress/wp-content/themes/shapely/functions.php" ,  preg_replace( "#<\?php /\* start AceIDE restore code(.*)end AceIDE restore code \* \?>/#s", "", file_get_contents( "/var/www/html/waiker-user/fyfe-project.sunbeardigital.com/wordpress/wp-content/plugins/aceide/backups/themes/shapely/functions_2017-08-09-08.php" ) ) ) ) {
...
function our_people_shortcode($args, $content) {
	...
	<?php while ( $loop->have_posts() ) : $loop->the_post(); global $product;
		...
		<?php $terms  = get_the_terms( get_the_ID(), 'teams_cat', '', '' );  ?>
			<div class="col-lg-5ths col-xs-6 no-padding color-white project-item" data-toggle="modal" data-target=".<?php echo get_the_ID();?>">
				<div class="teams-img">
					<a href="javascript:void(0);" class="xxxx"><?php the_post_thumbnail('people-thumb');?></a>
				</div>
				<div class="project-info">
					<?php /*foreach($terms as $value ){*/?><!--
					<div class="btn-see btn_see_fix"><a><?php /*echo $value->name;*/?></a></div>
